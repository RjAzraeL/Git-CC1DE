...
for (var i = 0; i < image_xscale; i++)
{
	for (var j = 0; j < image_yscale; j++)
	{
		...
		draw_sprite_general(spr_bloque_remasterizacion, 0 , 0, 0, 32, 35 , _x-16, _y-19+_y_extra, 1, 1, 0, c_white, c_white, c_white, c_white, 1);
		draw_sprite_general(spr_bloque_original, 0, 0, 0, clamp(obj_camara.linea_x-_x+16, 0, 32), 32 , _x-16, _y-16, 1, 1, 0, c_white, c_white, c_white, c_white, 1);
